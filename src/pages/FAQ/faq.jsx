          ...
          <section>
            <div className="section-container">
              ...
              <div className="question">
                ...
                <p>
                  HAYAT labs do not test on animals and do not ask others to do
                  so.
                </p>
                <h3>What is HAYAT?</h3>
                <p>
                  Please read about us in the About us section by clicking here.
                </p>
                ...
                <p>
                  {" "}
                  Please visit the contact page here to find a convenient way to
                  reach HAYAT, email or social channels.
                </p>
                <h3>
                  {" "}
                ...
                <p>
                  ...
                  If you have questions about any ingredient that we use, please
                  reach out to us here and our lab will provide a response.
                </p>
                ...
                <p>
                  ...
                  out of stock. If you click the “Email Me When in Stock” button
                  underneath the product you’re interested in, we’ll let you
                  know as soon as it’s restocked!
                </p>
                <h3>
                  {" "}
                ...
                <p>
                  {" "}
                  The shelf life of our products is indefinite, but we generally
                  suggest using any products from HAYAT within 6-12 months.
                  Please consult the period-after-opening symbol to be sure.
                  This can be found on the side of the box, as well as the
                  product itself.
                </p>
                <h3> Can You Recommend Products for My Skin Concerns?</h3>
                <p>
                  Of course, we would love to help! You can submit an inquiry on
                  our contact page and be sure to let us know what
                  products/brands you’re currently interested in, your primary
                  skin concerns, and your currently daily regimen (if you have
                  one).
                </p>
                <h3> How Do I know if My Products are Authentic or Genuine?</h3>
                <p>
                  {" "}
                  Unfortunately we are unable to verify the authenticity of any
                  products that are not purchased from HAYAT or one of our
